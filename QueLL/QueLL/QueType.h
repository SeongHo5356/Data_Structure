...
public: 
    ...
    void ReplaceItem_B(ItemType oldItem, ItemType newItem);
    ItemType Front(QueType<ItemType>& que);
...
template <class ItemType>
void ReplaceItem_A(QueType<ItemType> &queue, ItemType oldItem, ItemType newItem) {
    QueType temp_que;
    ItemType item;
    while (!queue.IsEmpty()) {
        //Dequeue
        ...
        {
            temp_que.Enqueue(item);
            queue.Dequeue(item);
        }
    }
    while (!temp_que.IsEmpty()) 
    {
        temp_que.Dequeue(item);
        queue.Enqueue(item);
    }
}

template <class ItemType>
void QueType<ItemType>::ReplaceItem_B(ItemType oldItem, ItemType newItem) {
...
template<class ItemType>
ItemType QueType<ItemType>::Front(QueType<ItemType>& que) {
    if (que.IsEmpty())
        throw EmptyQueue();
