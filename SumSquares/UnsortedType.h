...
void UnsortedType<ItemType>::PrintSumSquares()
{
    ...
    std::cout << sumSquares_A(listData) << std::endl; // a 번 함수
    std::cout << sumSquares_B(listData) << std::endl; // b 번 함수
    std::cout << sumSquares_C(listData) << std::endl; // c 번 함수
    std::cout << sumSquares_D(listData) << std::endl; // d 번 함수
    std::cout << sumSquares_E(listData) << std::endl; // e 번 함수
};
